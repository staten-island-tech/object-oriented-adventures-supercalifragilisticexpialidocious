        ...
        if self.check_gacha_ticket():
            ...
            if selected_rarity:
                ...
                if weapons_in_rarity:
                    Multipler = self.weapons_data[selected_rarity]["AttackPower"]
    ...
    def gacha(self):
        if self.check_gacha_ticket():
            ...
            if selected_rarity:
                ...
                if armors_in_rarity:
                    M = self.armors_data[selected_rarity]["Protection"]
    ...
    def gacha(self):
        if self.check_gacha_ticket():
            ...
            if selected_rarity:
                ...
                if pets_in_rarity:
                    M = self.pets_data[selected_rarity]["Multiplier"]
